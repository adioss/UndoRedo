package fr.adioss.undoredo {
     ...
     * diff.
     *
     * @author Charles Bihis (wwww.whoischarles.com)  with some of my modifications
     */
    public class StringDifferenceUtils {
         ...
         */
        public static function difference(before:String, after:String):Array {
         ...
         * @private
         */
        private static function getCommonPrefixLength(stringA:String, stringB:String):int {
         ...
         * @private
         */
        private static function getCommonSuffixLength(before:String, after:String):int {
         ...
         * @return An array of Operation objects describing the difference between the two given strings.
         */
        private static function compute(before:String, after:String):Array {
            ...
            if (halfMatch != null) {
                ...
                var diffsA:Array = difference(beforeA, afterA);
                var diffsB:Array = difference(beforeB, afterB);
         ...
         *            there was no match.
         */
        private static function diffHalfMatch(before:String, after:String):Array {
            var longText:String = before.length > after.length ? before : after;
            var shortText:String = before.length > after.length ? after : before;
         ...
         *            there was no match.
         */
        private static function diffHalfMatchSub(longText:String, shortText:String, i:int):Array {
         ...
         * @return An array of Operation objects describing the difference between the two given strings.
         */
        private static function bisect(before:String, after:String):Array {
         ...
         * @return An array of Operation objects describing the difference between the two given strings.
         */
        private static function bisectSplit(before:String, after:String, x:int, y:int):Array {
         ...
         */
        private static function merge(diffs:Array):Array {
            ...
            while (thisDiff != null) {
                switch (thisDiff.type) {
                    case "INSERT":
                        countInsert++;
                        textInsert += thisDiff.content;
                        prevEqual = null;
                        break;
                    case "DELETE":
                        countDelete++;
                        textDelete += thisDiff.content;
                        prevEqual = null;
                        break;
                    case "EQUAL":
                            ...
                            if (both_types) {
                                ...
                                if (commonLength != 0) {
                                    if (pointer > 0) {
                                        ...
                                        thisDiff.content += textInsert.substring(0, commonLength);
                                        pointer++;
                                    } else {
                                ...
                                if (commonLength != 0) {
                                    thisDiff = diffs[++pointer] as Operation;
                                    thisDiff.content = textInsert.substring(textInsert.length - commonLength) + thisDiff.content;
            ...
            if (Operation(diffs[diffs.length - 1]).content.length == 0) {
            ...
            while (nextDiff != null) {
                if (prevDiff.type == Operation.EQUAL && nextDiff.type == Operation.EQUAL) {
                    // This is a single edit surrounded by equalities.
                    if (endsWith(thisDiff.content, prevDiff.content)) {
                        // Shift the edit over the previous equality.
                        thisDiff.content = prevDiff.content + thisDiff.content.substring(0, thisDiff.content.length - prevDiff.content.length);
                        ...
                        changes = true;
                    } else if (beginsWith(thisDiff.content, nextDiff.content)) {
